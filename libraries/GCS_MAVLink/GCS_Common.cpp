...
void GCS_MAVLINK::handle_ai_landing_correction(const mavlink_message_t &msg)
{
    AP_AILanding *ai_landing = AP::ailanding();
    if (ai_landing != nullptr) {
        ai_landing->handle_msg(msg);
    }
}
