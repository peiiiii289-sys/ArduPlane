...
#define MAVLINK_FLIGHTSTACK_XML_HASH -2759146515634715124
...
typedef enum MAV_COMPONENT
{
   ...
   MAV_COMP_ID_UNICO_AI_COMPUTER=211, /* Uni-Co AI Computer Component ID | */
...
#include "./mavlink_msg_ai_fish_detection_result.h"
